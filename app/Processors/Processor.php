...
use LaravelLang\StatusGenerator\Contracts\Processable;
use LaravelLang\StatusGenerator\Services\Filesystem\Base;
use LaravelLang\StatusGenerator\Services\Filesystem\Json as JsonFilesystem;
use LaravelLang\StatusGenerator\Services\Filesystem\Markdown as MarkdownFilesystem;
use LaravelLang\StatusGenerator\Services\Filesystem\Php as PhpFilesystem;
...
abstract class Processor implements Processable
{
    ...
    /** @var \LaravelLang\StatusGenerator\Contracts\Filesystem[]|array */
